        ...
        <div class="container mx-auto px-4">
            <nav class="flex items-center gap-8 py-3">
                <div class="relative group">
                    ...
                    {{-- Mega Menu --}}
                    @php
                        // Categories ni safely olish
                        $headerCategories = isset($categories) ? $categories : \App\Models\Category::with('children')
                            ->whereNull('parent_id')
                            ->where('is_active', 1)
                            ->orderBy('order')
                            ->get();
                ...
                <a href="{{ route('brands.index') }}" class="hover:text-blue-600">Brandlar</a>
